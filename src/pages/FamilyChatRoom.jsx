...
import FamilyChatRoomComponent from '@/components/family/FamilyChatRoom';
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-orange-50 dark:from-slate-950 dark:via-pink-950 dark:to-orange-950 p-4 md:p-6 pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl p-6 md:p-8">
          <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-6">Family Chat</h1>
          <FamilyChatRoomComponent />
        </div>
      </div>
    </div>
  );

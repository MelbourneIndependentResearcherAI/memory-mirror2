...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-orange-100 via-pink-100 to-rose-100 dark:from-orange-950 dark:via-pink-950 dark:to-rose-950 border-t-4 border-orange-300 dark:border-orange-700 py-8 px-4 mt-0">
